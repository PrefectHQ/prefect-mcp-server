...
async def get_identity() -> IdentityResult:
    ...
    try:
        ...
        # Determine server type and fetch identity within the appropriate settings context
                ...
                if determine_server_type() == ServerType.CLOUD:
                    ...
                    async with cloud_client:
                        ...
                        identity: CloudIdentityInfo = {
                            ...
                            "mex_work_pool_limit": account_data.get(
                                "mex_work_pool_limit"
                            ),
                            "run_retention_days": account_data.get(
                                "run_retention_days"
                            ),
