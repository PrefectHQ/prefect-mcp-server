...
| **cloud_oauth/test_cross_workspace** | verifies Cloud OAuth mode can answer support-style questions across consented workspaces | ✅ implemented | - |
| **cloud_oauth/test_workspace_selection** | verifies Cloud OAuth mode can select the intended workspace from natural-language account/workspace handles | ✅ implemented | - |
