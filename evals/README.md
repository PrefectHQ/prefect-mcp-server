...
| **rate_limits/test_cloud_oauth_workspace_selection** | verifies Cloud OAuth mode can select the intended workspace from natural-language account/workspace handles | ✅ implemented | - |
